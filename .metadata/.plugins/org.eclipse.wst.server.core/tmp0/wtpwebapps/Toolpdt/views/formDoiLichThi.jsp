                    ...
                    <form action="/Toolpdt/Uploadkht" enctype="multipart/form-data" method="post" >
                        <div class="container_body">
                            <div class="container_body-button">
                                <input type="file" id="namfile" name="namefile" class="btnFile" onchange="return fileValidation()"></input>
                            </div>
                            <div class="container_body-cbb">
                               
                            </div> 
                            <div class="container_body-submit">
                                <button formaction="/Toolpdt/Uploadkht?id=${id}" class="btn_submit" onclick = "GFG_Fun()">SUBMIT</button>
                            </div>
                        </div>
                    </form>
